package com.springproject.course.infra.config;
...
import com.springproject.course.domain.entities.Payment;
...
import com.springproject.course.domain.entities.enums.OrderStatus;
import com.springproject.course.domain.repositories.CategoryRepository;
import com.springproject.course.domain.repositories.OrderItemRepository;
import com.springproject.course.domain.repositories.OrderRepository;
import com.springproject.course.domain.repositories.ProductRepository;
import com.springproject.course.domain.repositories.RoleRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User u3 = new User(null, "Admin", "admin@gmail.com", "99999999", passwordEncoder.encode("123456"));
